...
public:
    Sedan();
    Sedan(int car_id, string car_make, string car_model, float car_price, int car_seating_capacity, int car_ground_clearance, string is_car_available, float fuel_efficiency, float trunk_capacity);
